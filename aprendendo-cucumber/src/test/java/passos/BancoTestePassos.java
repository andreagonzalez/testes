...
//Esta classe erá chamada pelo Cucumber (mediante a chamada da classe BancoTeste) para executar 
//os passos (teses de aceitação) definidos no arquivo banco.feature.
